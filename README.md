...
This section reflects the post-v3.0 state of the pipeline (Phases 12–19). For deeper detail on propagation contracts and limitations, see [docs/known-limitations.md](docs/known-limitations.md).
