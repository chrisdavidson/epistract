...
### README Pipeline Capacity & Limits (Phase 20)

- [x] **FIDL-09**: `README.md` has a new `## Pipeline Capacity & Limits` section between `## How It Works` and `## Pre-built Domains` documenting the post-v3.0 (Phases 12–19) pipeline state — four subsections (Document Ingestion, Wizard Schema Discovery, Extraction & Graph Build, Epistemic Layer), each with a `Feature | Value | Notes` table and "Known limits" bullets referencing `docs/known-limitations.md` for depth. Every claim is grep-verifiable; no aspirational numbers. Section is concise (≤150 lines of markdown). Completion of FIDL-09 closes the v3.0 milestone "Graph Fidelity & Honest Limits."
...
*Last updated: 2026-04-22 — FIDL-09 Phase 20 complete (README Pipeline Capacity & Limits)*
